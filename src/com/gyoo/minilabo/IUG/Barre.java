...
public class Barre {
	...
	public Vecteur2f pos = new Vecteur2f(0); //Position de la barre en pixels
	public Vecteur2f éch = new Vecteur2f(100f); //Échelle de la barre. Facteur de grandeur en pixels
